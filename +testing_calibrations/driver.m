...
M_.params(12) = ctou_calib;
ctou = M_.params(12);
M_.params(23) = clandaw_calib;
clandaw = M_.params(23);
M_.params(39) = cg_calib;
cg = M_.params(39);
M_.params(3) = curvp_calib;
curvp = M_.params(3);
M_.params(1) = curvw_calib;
curvw = M_.params(1);
M_.params(9) = .24;
calfa = M_.params(9);
M_.params(13) = 1.5;
...
options_.datafile = 'temp';
options_.first_obs = 71;
options_.order = 1;
var_list_ = {};
oo_recursive_=dynare_estimation(var_list_);
if i == 1
output = oo_.posterior_mode.parameters; 
output = rows2vars(struct2table(output)); 
column_name = ['mode_', num2str(i)]; 
output.Properties.VariableNames = {'param_name' column_name}; 
output_bis = oo_.posterior_mode.shocks_std; 
output_bis = rows2vars(struct2table(output_bis)); 
output_bis.Properties.VariableNames = {'param_name' column_name}; 
output = [output; output_bis];
else
temp = oo_.posterior_mode.parameters; 
temp = rows2vars(struct2table(temp)); 
column_name = ['mode_', num2str(i)]; 
temp.Properties.VariableNames = {'param_name' column_name}; 
temp_bis = oo_.posterior_mode.shocks_std; 
temp_bis = rows2vars(struct2table(temp_bis)); 
temp_bis.Properties.VariableNames = {'param_name' column_name}; 
temp = [temp; temp_bis];
...
options_.no_graph.posterior = true;
...
oo_recursive_=dynare_estimation(var_list_);
if i == 1
output = oo_.posterior_mean.parameters; 
output = rows2vars(struct2table(output)); 
column_name = ['mean_', num2str(i)]; 
output.Properties.VariableNames = {'param_name' column_name}; 
output_bis = oo_.posterior_mean.shocks_std; 
output_bis = rows2vars(struct2table(output_bis)); 
output_bis.Properties.VariableNames = {'param_name' column_name}; 
output = [output; output_bis];
else
temp = oo_.posterior_mean.parameters; 
temp = rows2vars(struct2table(temp)); 
column_name = ['mean_', num2str(i)]; 
temp.Properties.VariableNames = {'param_name' column_name}; 
temp_bis = oo_.posterior_mean.shocks_std; 
temp_bis = rows2vars(struct2table(temp_bis)); 
temp_bis.Properties.VariableNames = {'param_name' column_name}; 
temp = [temp; temp_bis];
output = join(output, temp); 
...
save([M_.dname filesep 'Output' filesep 'testing_calibrations_results.mat'], 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'testing_calibrations_results.mat'], 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'testing_calibrations_results.mat'], 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'testing_calibrations_results.mat'], 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'testing_calibrations_results.mat'], 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'testing_calibrations_results.mat'], 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'testing_calibrations_results.mat'], 'oo_recursive_', '-append');
end
if ~isempty(lastwarn)
